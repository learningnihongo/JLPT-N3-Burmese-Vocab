...
fun getPaletteDarkColorScheme(palette: ThemePalette, isOled: Boolean = false): ColorScheme {
    ...
    return when (palette) {
        ...
        ThemePalette.MATCHA -> darkColorScheme(
            ...
            surfaceVariant = surfVar,
            onSurfaceVariant = Color(0xFFC4DBC4),
            outline = Color(0xFFA0BBA0),
        ...
        ThemePalette.SAKURA -> darkColorScheme(
            ...
            background = bg,
            onBackground = Color(0xFFFDF2F5),
            surface = surf,
            onSurface = Color(0xFFFDF2F5),
            surfaceVariant = surfVar,
            onSurfaceVariant = Color(0xFFE4CAD4),
            outline = Color(0xFFC4A2B2),
        ...
        ThemePalette.FUJI -> darkColorScheme(
            ...
            background = bg,
            onBackground = Color(0xFFF8F2FC),
            surface = surf,
            onSurface = Color(0xFFF8F2FC),
            surfaceVariant = surfVar,
            onSurfaceVariant = Color(0xFFD8CCE0),
            outline = Color(0xFFB8A5C4),
        ...
        ThemePalette.KOGANE -> darkColorScheme(
            ...
            surfaceVariant = surfVar,
            onSurfaceVariant = Color(0xFFE0D3BE),
            outline = Color(0xFFBFAF9B),
