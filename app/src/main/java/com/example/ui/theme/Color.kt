...
val PolishDarkBackground = Color(0xFF141218)
val PolishDarkSurface = Color(0xFF1D1B20)
val PolishDarkSurfaceVariant = Color(0xFF28252E)
val PolishDarkOutline = Color(0xFFA8A29E) // Accessible contrast >= 4.5:1 on dark surfaces
val PolishDarkOutlineVariant = Color(0xFF49454F)
val PolishDarkOnSurface = Color(0xFFF4EFF4)
val PolishDarkOnSurfaceVariant = Color(0xFFD3CCD8)
...
val MasteredGreen = Color(0xFF16A34A)
val MasteredGreenDark = Color(0xFF4ADE80)
val ReviewBlue = Color(0xFF0284C7)
val ReviewBlueDark = Color(0xFF38BDF8)
val WeakOrange = Color(0xFFF97316)
val SakuraPinkDark = Color(0xFFF48FB1)

// Backward Compatibility Aliases
val JapaneseCrimson = PolishPrimary
val JapaneseCrimsonDark = PolishPrimaryDark
val CrimsonPrimary = PolishPrimary
val CrimsonPrimaryDark = PolishPrimaryDark
val JapaneseIndigo = PolishOnPrimaryContainer
val JapaneseIndigoLight = PolishSecondary
val IndigoDeep = PolishOnPrimaryContainer
